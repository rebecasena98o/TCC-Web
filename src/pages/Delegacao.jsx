...
import '../Style/StyleDelegacao.css';
...
const initialTickets = [
  { id: 1, aluno: 'Maria Silva',    titulo: 'Análise de Sistemas de Informação', bibliotecario: 'Dr. Carlos Oliveira',   status: 'Em Revisão', data: '2026-04-26' },
  { id: 2, aluno: 'João Santos',    titulo: 'Impactos da IA no Mercado',          bibliotecario: 'Dr. Carlos Oliveira',   status: 'Pendente',   data: '2026-04-28' },
  { id: 3, aluno: 'Ana Costa',      titulo: 'Sustentabilidade Corporativa',        bibliotecario: 'Dra. Fernanda Costa',   status: 'Em Revisão', data: '2026-04-27' },
  { id: 4, aluno: 'Pedro Oliveira', titulo: 'Marketing Digital',                   bibliotecario: 'Dra. Ana Paula Santos', status: 'Aprovado',   data: '2026-04-10' },
];
      ...
      <div className="modal-box">
        <div className="modal-header">
          <div className="modal-header-left">
            <img src={logoUnifor} alt="Logo Unifor" className="modal-logo" />
            <div>
              <h2 className="modal-title">Transferir Revisão</h2>
              <p className="modal-subtitle">Transferir trabalho de um bibliotecário para outro</p>
            </div>
          </div>
        ...
        <div className="modal-body">
          ...
          <div className="modal-info-block">
            ...
            <span className="modal-value">{ticket.bibliotecario}</span>
          </div>
          ...
          <div className="modal-field-group">
            <label className="modal-field-label">Motivo da transferência:</label>
            <input
        ...
        <div className="modal-footer">
          ...
          <button className="btn-confirmar" onClick={handleConfirm} disabled={!destino}>
  ...
  return (
    <div className="delegacao-page">
      ...
      <main className="delegacao-main">
        {feedback && <div className="delegacao-toast">✓ {feedback}</div>}
        <section className="delegacao-card">
          <h2 className="delegacao-card-title">Trabalhos e Atribuições</h2>
                ...
                <tr key={t.id}>
                  ...
                  <td>
                    <button
                      ...
                      title={t.status === 'Aprovado' ? 'TCC aprovado — transferência bloqueada' : 'Transferir revisão'}
                    >
                      ⇄ Transferir
                    </button>
                  </td>
